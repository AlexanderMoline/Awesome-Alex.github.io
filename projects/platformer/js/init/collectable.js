(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 170, 9, 0.7);
        collectable.create(type.kennedi, 500,575, 10.81, 1)
        collectable.create(type.kennedi, 530, 100, 10.81, 1)
        collectable.create(type.kennedi, 1100,320,0,0)
